...
<body>
    ...
    <div class="main-log">
        <div>
            <a href="profile.php" class="m-l-text">Мой профиль &#128100;</a>
        </div>
        <div>
            <a href="driver_orders.php" class="m-l-text">Посмотреть историю моих заказов &#128221;</a>
        </div>
        <div>
            <a href="login.php" class="m-l-text">Выйти &#128164;</a>
        </div>
    </div>
